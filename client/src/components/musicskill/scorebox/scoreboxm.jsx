...
import './scoreboxm.css';

export default function Scoreboxm(props) {
    return (
        <div className="container-fluid">

            <div className="container shadow-lg rounded-5 mt-2 bg-primary text-white">
                ...
                <div className="row  mb-3">
                    ...
                    <div className="col-6 border-left border-white">
                        ...
                        <center>
                        <img className="img-fluid mb-1 mt-1" src={"/images/badgesm/"+props.level+"M.svg"} />
                        </center>
