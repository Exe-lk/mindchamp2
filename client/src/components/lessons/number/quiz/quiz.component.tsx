...
const QuizComponent: React.FC<Props> = ({quizId, ans, question, imgUri, getAnswerHandler}) => {
    console.log("############", quizId)
            ...
            <div className="flex justify-center p-5 h-full">
                <div className="flex flex-col mx-20 p-2">
                    ...
                    <div className="text-base my-5">
                        <Input size="large" type="text" value={transcribedData}
                               placeholder={transcribedData + ""}/>
                    </div>
                    {isRecording ?
